...
func openapiDinosaursYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "openapi.dinosaurs.yaml", size: 9504, mode: os.FileMode(420), modTime: time.Unix(1759917787, 0)}
...
func openapiYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "openapi.yaml", size: 4860, mode: os.FileMode(420), modTime: time.Unix(1759917787, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
